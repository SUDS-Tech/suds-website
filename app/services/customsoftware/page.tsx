        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Every business is unique — we engineer custom software for
              enterprises designed specifically for your workflows, scale, and
              long-term goals.
            </p>
            <div className="mt-8">
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <p className="text-gray-400 text-sm">
                Durability, minimizing technical debt, while enabling future
                growth.
              </p>
            </div>
          </div>
