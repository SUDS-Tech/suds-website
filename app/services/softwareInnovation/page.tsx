        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Our Innovation Lab helps startups and enterprises transform ideas
              into production-ready software through rapid prototyping and
              experimentation.
            </p>
            <div className="mt-8">
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <p className="text-gray-400 text-sm">
                Startups and enterprises looking to move from concept to
