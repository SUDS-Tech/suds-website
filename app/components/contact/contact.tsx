...
export default function ContactForm() {
  ...
  return (
    <section className="min-h-screen bg-[#0d1117] relative overflow-hidden pt-20">
      {/* Particle Background */}
      <ParticleBackground />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <article className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Quick Info Card */}
            <div className="card bg-linear-to-br from-emerald-500/5 to-emerald-600/5 border-emerald-500/20">
