    ...
    <div className="bg-gray-800/30 p-6 rounded-2xl border border-gray-700/30 backdrop-blur-sm">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="group w-full px-4 py-3 bg-linear-to-r from-emerald-500 to-emerald-600 text-white text-sm font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 flex items-center justify-center gap-2"
        >
          Subscribe
