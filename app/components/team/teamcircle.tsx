...
function TeamCircle() {
  return (
    <div className="flex flex-col justify-center items-center py-16 bg-[#0d1117]">
      <h2 className="text-white text-3xl font-bold pb-8">How we work</h2>
      <div className="w-100 h-100 p-6 bg-[#161b22] border border-gray-800 rounded-full flex justify-center items-center">
        <div className="relative border-2 border-emerald-500/30 w-60 h-60 rounded-full">
          {/* Collaboration first */}
          <div className="absolute -right-20 top-16 bg-[#161b22] border border-gray-800 rounded-lg py-3 px-4">
          ...
          {/* Quality work */}
          <div className="absolute -left-16 top-16 bg-[#161b22] border border-gray-800 rounded-lg py-3 px-4">
            <div className="flex flex-col justify-center items-center">
          ...
          <div className="absolute -bottom-6 left-8 bg-[#161b22] border border-gray-800 rounded-lg py-3 px-4">
            <div className="flex flex-col justify-center items-center">
